...
对于 Dubbo 中的URL，很多人称之为“配置总线”，也有人称之为“统一配置模型”。虽然说法不同，但都是在表达一个意思，URL 在 Dubbo 中被当作是“**公共的契约**”。一个 URL 可以包含非常多的扩展点参数，URL 作为上下文信息贯穿整个扩展点设计体系。
...
Dubbo SPI 中有一个依赖 URL 的重要场景——<font color=red>适配器方法</font>，是被 @Adaptive 注解标注的， URL 一个很重要的作用就是与 @Adaptive 注解一起选择合适的扩展实现类。
...
![Drawing 0.png](./image/02Dubbo的配置总线/Ciqc1F8j2R2AO15wAAGHCEMA4ig361.png)
...
![Drawing 1.png](./image/02Dubbo的配置总线/Ciqc1F8j2aGAJmTVAAI-2XB7V7o382.png)
...
![Lark20200731-183202.png](./image/02Dubbo的配置总线/CgqCHl8j822Aa3VpAAPpUoCBlf4288.png)

我们看到传入的 URL 参数如下：

```auto
consumer://...?application=dubbo-demo-api-consumer
