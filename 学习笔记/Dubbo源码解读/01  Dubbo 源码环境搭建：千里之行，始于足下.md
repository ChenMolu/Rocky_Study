...
![Drawing 0.png](./image/01  Dubbo 源码环境搭建：千里之行，始于足下/CgqCHl8eRaCAW4-LAAB7_C-aKWA601.png)
...
![Drawing 2.png](./image/01  Dubbo 源码环境搭建：千里之行，始于足下/Ciqc1F8eRcOAdzNmAADHxcenG7I722.png)
...
![Drawing 4.png](./image/01  Dubbo 源码环境搭建：千里之行，始于足下/CgqCHl8eRfWANQSTAAHowsC6F8s134.png)
...
![Drawing 5.png](./image/01  Dubbo 源码环境搭建：千里之行，始于足下/Ciqc1F8eRgCAR30EAABc4PYop3w206.png)
...
![Drawing 6.png](./image/01  Dubbo 源码环境搭建：千里之行，始于足下/Ciqc1F8eRguAA8jOAABqHomePJk138.png)
...
![Drawing 7.png](./image/01  Dubbo 源码环境搭建：千里之行，始于足下/CgqCHl8eRhWANEiTAAB2ATuQ2vc619.png)
...
![Drawing 8.png](./image/01  Dubbo 源码环境搭建：千里之行，始于足下/CgqCHl8eRhyAVJ43AAAaPAwMeQ4525.png)

+   **dubbo-metadata 模块：** Dubbo 的元数据模块（本课程后续会详细介绍元数据的内容）。dubbo-metadata 模块的实现套路也是有一个 api 子模块进行抽象，然后其他子模块进行具体实现。
    

![Drawing 9.png](./image/01  Dubbo 源码环境搭建：千里之行，始于足下/CgqCHl8eRiSAPFIYAABXCRqgsNA891.png)

+   **dubbo-configcenter 模块：** Dubbo 的动态配置模块，主要负责外部化配置以及服务治理规则的存储与通知，提供了多个子模块用来接入多种开源的服务发现组件。
    

![Drawing 10.png](./image/01  Dubbo 源码环境搭建：千里之行，始于足下/CgqCHl8eRiuAM7LfAAA9BmMR2zY483.png)
...
![Drawing 11.png](./image/01  Dubbo 源码环境搭建：千里之行，始于足下/CgqCHl8eRlWAPwvCAACx42Xn9Dk409.png)
...
![Drawing 12.png](./image/01  Dubbo 源码环境搭建：千里之行，始于足下/CgqCHl8eRmKAT8LjAADV8C5fM8E391.png)
...
![Drawing 13.png](./image/01  Dubbo 源码环境搭建：千里之行，始于足下/Ciqc1F8eRnuAWnTAAAE7eBUfEoA405.png)
